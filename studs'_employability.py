...
# Check the available columns to ensure that 'COMMUNICATION_SKILLS' or similar exists
print("Columns in the dataset:\n", data_cleaned.columns)

# If 'COMMUNICATION_SKILLS' does not exist, we handle it
if 'COMMUNICATION_SKILLS' not in data_cleaned.columns:
    print("'COMMUNICATION_SKILLS' column is not available in the dataset.")
    # We can either skip the communication skills analysis or use other available columns for analysis
else:
    # Distribution plots for Communication Skills Total if available
